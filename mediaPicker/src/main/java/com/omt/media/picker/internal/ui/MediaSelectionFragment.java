...
import com.omt.media.picker.internal.model.AlbumMediaCollection;
...
import com.omt.media.picker.internal.ui.widget.MediaGridInset;
import com.omt.media.picker.internal.utils.UIUtils;
...
public class MediaSelectionFragment extends Fragment implements
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (selectionSpec.gridExpectedSize > 0) {
            spanCount = UIUtils.spanCount(getActivity(), selectionSpec.gridExpectedSize);
        } else {
